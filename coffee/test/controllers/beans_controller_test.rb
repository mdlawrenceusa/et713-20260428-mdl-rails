...
class BeansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bean" do
    assert_difference("Bean.count") do
      post beans_url, params: { bean: { description: @bean.description, price: @bean.price, product_name: @bean.product_name, quantity: @bean.quantity, supplier_id: @bean.supplier_id, type: @bean.type } }
    end
  ...
  test "should update bean" do
    patch bean_url(@bean), params: { bean: { description: @bean.description, price: @bean.price, product_name: @bean.product_name, quantity: @bean.quantity, supplier_id: @bean.supplier_id, type: @bean.type } }
